...
export const ErrorMessage: {
  ...
  [Errors.StrictDecimalWithLeadingZero]:
  ...
  [Errors.IDStartAfterNumber]:
    'No identifiers allowed directly after numeric literal',
  [Errors.InvalidEightAndNine]:
  ...
  [Errors.InvalidEscapeIdentifier]:
  ...
  [Errors.InvalidComputedPropName]:
    'A computed property name must be followed by a colon or paren',
  [Errors.InvalidObjLitKey]:
  ...
  [Errors.InvalidArrowDestructLHS]:
    'The left-hand side of the arrow can only be destructed through assignment',
  [Errors.InvalidBindingDestruct]:
    'The binding declaration is not destructible',
  [Errors.ExpectedBindingIdent]: 'Expected an binding identifier',
  [Errors.ExpectedAnIdentifier]: 'Expected an identifier',
  [Errors.InvalidAsyncArrow]:
  ...
  [Errors.InvalidLHSPreOp]:
    'Invalid left-hand side expression in prefix operation',
  [Errors.InvalidLHSPostOp]:
    'Invalid left-hand side expression in postfix operation',
  [Errors.InvalidIncDecNew]:
  ...
  [Errors.ForInOfLoopMultiBindings]:
  ...
  [Errors.InvalidLetBracket]:
    'Cannot have `let[...]` as a var name in strict mode',
  [Errors.InvalidDestructuringTarget]:
  ...
  [Errors.RestricedLetProduction]:
    '`let \n [` is a restricted production at the start of a statement',
  [Errors.InvalidCatchParams]:
    'Catch clause requires exactly one parameter, not more (and no trailing comma)',
  [Errors.InvalidCatchParamDefault]:
  ...
  [Errors.InvalidForLHSBinding]:
    'The left hand side of the for-header binding declaration is not destructible',
  [Errors.InvalidNewTarget]:
    '`%0` is not a valid meta-property for keyword `new`.',
  [Errors.InvalidEscapedKeyword]: "'Unexpected token: 'escaped keyword'",
  ...
  [Errors.InvalidKeywordAsAlias]:
    'Only a identifier can be used to indicate alias',
  [Errors.InvalidDefaultImport]:
  ...
  [Errors.UndeclaredExportedBinding]:
  ...
  [Errors.InvalidJSXAttributeValue]:
    'JSX value should be either an expression or a quoted JSX text',
  [Errors.ExpectedJSXClosingTag]:
    'Expected corresponding JSX closing tag for %0',
  [Errors.AdjacentJSXElements]:
    'Adjacent JSX elements must be wrapped in an enclosing tag',
  [Errors.InvalidNonEmptyJSXExpr]:
  ...
  [Errors.UnCorrespondingFragmentTag]:
  ...
  [Errors.OptionalChainingNoSuper]:
  ...
  [Errors.MissingFunctionName]: 'Function declaration require a function name',
  [Errors.MissingClassName]: 'Class declaration require a function name',
};
